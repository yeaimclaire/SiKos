                        ...
                        foreach ($transaksi as $tr) : ?>
                            ...
                            <?php } ?>
                                ...
                                <td> <?php if (empty($tr->bukti_pembayaran)) { ?>
                                        <button class="btn btn-danger waves-effect">Belum Lunas<i class="fas fa-times-circle"></i></button>
                                    <?php } else { ?>
                                        <a href="<?= base_url('admin/transaksi/cek_pembayaran/' . $tr->id_booking) ?>" class="btn btn-info waves-effect">Lunas<i class="fas fa-check-circle"></i></a>
                                    <?php } ?>
                                </td>
