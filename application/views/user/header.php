        ...
        <div class="row no-gutters slider-text align-items-center">
          <div class="col-lg-7 col-md-6 ftco-animate d-flex align-items-end">
          	<div class="text">
	            ...
	            <p><a href="#" class="btn btn-primary py-3 px-4">Mulai cari kost</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="ftco-section ftco-no-pt">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
    		...
    		<div class="row">
    			<div class="col-md-4">
    				<a href="#" class="search-place img" style="background-image: url(asset/images/place-1.jpg);">
							<div class="desc">
    			...
    			<div class="col-md-4">
    				<a href="#" class="search-place img" style="background-image: url(asset/images/place-2.jpg);">
							<div class="desc">
    			...
    			<div class="col-md-4">
    				<a href="#" class="search-place img" style="background-image: url(asset/images/place-3.jpg);">
							<div class="desc">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt">
			<div class="container">
	          ...
	          <div class="heading-section pr-md-5">
	            ...
	            <p>Kami menyediakan website informasi kost untuk anda yang sedang mencari kost sesuai dengan area yang dituju dengan menyertakan harga, fasilitas, nomor pemilik kost, dan juga informasi detail lainnya.</p>
	            <p>Tentunya website kami akan mempermudah anda untuk mencari kost sesuai dengan area yang anda tuju dan juga keinginan anda. Kami juga menyediakan beberapa fitur yang akan mempermudah dalam proses pencarian, tentunya anda dapat menggunakan fitur-fitur ini dengan mudah. Awal mula SevenKos dibuat dikarenakan keluhan yang dialami pelajar, mahasiswa, atau bahkan kami sendiri dalam mencari informasi kost pada daerah tujuan kami.</p>
	          </div>
					</div>
				</div>
			</div>
